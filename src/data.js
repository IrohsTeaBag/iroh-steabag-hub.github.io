...
export const PROJECT_SEED = [
  {
    ...
    goal: "Assess a lab web application for OWASP Top 10 vulnerabilities and validate real, exploitable security issues using a structured penetration testing methodology.",
    whatIDid: "Mapped the application's attack surface, tested authentication and session handling, and used Burp Suite to probe for SQL injection, XSS, and CSRF across forms and API endpoints in a VMware-hosted lab environment.",
    whatIFound: "Identified exploitable SQL injection and reflected XSS entry points, along with API endpoints that lacked proper access control checks.",
    whatILearned: "How to move from automated scanning to manual exploitation and validation, and how to write findings up to a professional reporting standard that a client or employer would actually use.",
    skillProven: "Web application penetration testing using Burp Suite and OWASP Top 10 methodology.",
    metrics: [
  ...
  },
  {
    ...
    goal: "Capture real-world attack traffic from the internet and build visibility into it using a cloud SIEM.",
    whatIDid: "Deployed a honeypot instance on Microsoft Azure, exposed it to the internet, and forwarded its telemetry into Microsoft Sentinel, then built correlation logic to surface attacker behavior.",
    whatIFound: "Live brute-force and scanning traffic hitting the honeypot within hours of deployment, which I used to test and tune Sentinel's alerting and correlation rules.",
    whatILearned: "How SIEM correlation rules turn raw log noise into actionable alerts, and how cloud-hosted honeypots behave differently from lab-only simulations.",
    skillProven: "SIEM configuration and threat correlation using Microsoft Sentinel.",
    metrics: [
  ...
  },
  {
    ...
    goal: "Build a working SOC monitoring pipeline at home to practice real detection engineering and alert triage.",
    whatIDid: "Deployed a Wazuh manager and agents across a virtualized lab, aggregated Windows endpoint logs, and configured automated alerting for suspicious activity.",
    whatIFound: "Default rulesets generated a lot of noise, so I had to tune detection rules to cut false positives while still catching legitimate suspicious behavior.",
    whatILearned: "How log aggregation and rule tuning directly affect analyst workload, and practical experience with Tier 1 SOC triage workflows.",
    skillProven: "SIEM administration and endpoint monitoring using Wazuh.",
    metrics: [
  ...
  },
  {
    ...
    goal: "Understand how IT-side offensive tooling applies to industrial control systems by building a hands-on OT security testbed.",
    whatIDid: "Set up a physical Siemens S7-1200 PLC test bed, used python-snap7 and Kali Linux tooling to interact with S7comm, and documented weaknesses in the industrial control communications.",
    whatIFound: "The PLC communications lacked meaningful authentication, making it possible to interact with the device using standard tooling without needing specialized OT exploits.",
    whatILearned: "How the IT/OT security gap plays out in practice, and why network segmentation matters more than software fixes in industrial environments.",
    skillProven: "OT/ICS security assessment and PLC communication analysis.",
    metrics: [
